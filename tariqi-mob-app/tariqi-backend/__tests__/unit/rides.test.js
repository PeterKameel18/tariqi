...
const mockOrsResponse = (distance = 5000, duration = 600) => {
...
describe("Rides Controller - Advanced Tests", () => {
  describe("POST /api/client/get/rides (with mocked ORS)", () => {
    let rideId;
    ...
    it("should handle ORS API failures gracefully", async () => {
      axios.mockRejectedValue(new Error("ORS API down"));
