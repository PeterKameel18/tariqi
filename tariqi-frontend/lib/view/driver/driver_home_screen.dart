...
class _DriverHomeScreenState extends State<DriverHomeScreen> 
  ...
  void _logRideTerminationEntry(String methodName, {String? rideId, String? extra}) {
    ...
    log("🧭 RIDE_TERMINATION_ENTRY method=$methodName rideId=${rideId ?? Get.find<DriverService>().currentRideId ?? 'null'} route=$route timestamp=$now extra=${extra ?? ''}");
    log("🧭 RIDE_TERMINATION_STACK method=$methodName\n$stack");
  }
  ...
  void dispose() {
    ...
    _logRideTerminationEntry(
      'DriverHomeScreen.dispose',
      extra: 'Skipping ride termination on route disposal; cleanup remains in detached lifecycle only',
    );
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    _logRideTerminationEntry(
      'DriverHomeScreen.didChangeAppLifecycleState',
      extra: 'state=$state',
    );
    
    // Only end rides when app is actually closing (detached), not when navigating (paused)
    // Paused state occurs during normal navigation and should NOT end rides
              ...
              Positioned.fill(
                child: IgnorePointer(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      color: Colors.black.withValues(alpha: _backgroundDimAnimation.value),
                    ),
                  ),
                ),
              ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ListTile(
                            key: const Key('key_driverMenu_logout'),
                ...
                children: [
                  ...
                  Obx(() => controller.requestState.value == RequestState.loading
                      ...
                      : SizedBox(
                          ...
                          child: DecoratedBox(
                            decoration: BoxDecoration(
                              gradient: controller.isReadyToStart.value
                                  ? AppColors.primaryGradient
                                  : null,
                              color: controller.isReadyToStart.value
                                  ? null
                                  : AppColors.border,
                              borderRadius: BorderRadius.circular(14),
                              boxShadow: controller.isReadyToStart.value
                                  ? [
                                      BoxShadow(
                            ...
                            child: ElevatedButton.icon(
                              key: const Key('key_driverHome_startRide'),
        ...
        Row(
          children: [
            Container(
              ...
              child: IconButton(
                key: const Key('key_driverHome_menuButton'),
                onPressed: menuFunction,
                icon: Icon(
                  isMenuOpen ? Icons.arrow_back_rounded : Icons.menu_rounded,
                  size: 24,
                  color: AppColors.textPrimary,
                ),
              ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.location_disabled_rounded, color: AppColors.warning, size: 20),
                  ...
                  const Text(
                    "Enable location to create rides and connect with passengers",
        ...
        children: [
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              ...
              child: Obx(
                () => Icon(
                  controller.usingDefaultLocation.value
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Icon(Icons.location_on_rounded, color: AppColors.primaryBlue, size: 22),
      ...
      child: Row(
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text("Resume", style: TextStyle(fontWeight: FontWeight.w600)),
          ),
        ],
      ),
    );
